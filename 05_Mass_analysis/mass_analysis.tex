...
%Figure~\ref{fig:mass} shows the fitted massed for $e+$jets
%and $\mu$+jets combined, for 100k pseudo experiments at each of the mass values. The fitted
%mass distributions are nicely gaussian. 

%\begin{figure}[!htp]
%   \centering
%   \subfigure[]{\includegraphics[width=0.49\textwidth]{fig/massplot}}
%   \subfigure[]{\includegraphics[width=0.49\textwidth]{fig/logmassplot}}
%   \caption{ Fitted pseudo experiment masses, for three values of the generated top mass,
%            with linear (a) and logarithmic (b) scale (\bf TO BE UPDATED).
%   \label{fig:mass}}
%\end{figure}
%\begin{figure}[!htp]
%   \centering
%   \subfigure[]{\includegraphics[width=0.49\textwidth]{fig/pullplot}}
%   \subfigure[]{\includegraphics[width=0.49\textwidth]{fig/logpullplot}}
%   \caption{Pull distribution of the fitted pseudo experiment masses, for the central sample with
%            top mass of 172.5 GeV,
%            with linear (a) and logarithmic (b) scale (\bf TO BE UPDATED).
%   \label{fig:pull}}
%\end{figure}


The same procedure is repeated for the $e+$jets channel only, the $\mu$+jets channel only, and the two channels
