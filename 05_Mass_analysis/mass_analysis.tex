...
% Non-perturbative QCD effects are taken into account by tuning $\textsc {pythia}$ to
...
As it was mentioned in the description of mass calibration (Section~\ref{s_top_mass:calibration}), the background in
...
described by 22 orthogonal parameters. To estimate the systematic uncertainty do to the choice of PDFs, the up and down
