...
\input{05_Mass_analysis/tables/systematic_mc_variations}
...
\input{05_Mass_analysis/tables/top_mass_event_yields}
...
\begin{figure}[!htp]
   ...
   \caption[Average mass bias and width of the pull as a function of the true top quark mass before and after
   calibration]{Average mass bias and width of the pull as a function of the true top quark mass before (a, b) and after
   (c, d) calibration.}
