...
The second term shows the probability of a wrong permutation, i.e.\ with a wrong jet-parton assignment. The
wrong-permutation probability density is derived by fitting analytical functions to the fitted mass distribution of
