...
\midrule
\WpJets ($\W \rightarrow l\nu$) & $\MADGRAPH+\PYTHIA$ & 31314 & 81345381 & 2.6 \\
...
\begin{table}[!htbp] 
\centering
\caption[QCD multi-jet background and $\gamma$ + jets MC samples at $\sqrt s = \SI{7}{\TeV}$]{QCD multi-jet background
and $\gamma$ + jets MC samples with cross sections at $\sqrt s = \SI{7}{\TeV}$, numbers of generated events and
...
\midrule
$\gamma$ + jets 												& \MADGRAPH & & & & \\
\hspace{5 mm}\SIrange[range-phrase = $~<\HT<~$]{40}{100}{\GeV}  & +\PYTHIA  & \num{23620} & 1 & 12730863 & \num{0.5} \\
