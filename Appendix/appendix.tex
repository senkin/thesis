...
\chapter{High-level triggers in 2011 data}
\label{a:full_trigger_list}
 
A full list of electron triggers including their version numbers used in the top quark mass analysis
...
\small
 ...
 \item HLT-Ele25-CaloIdVT-CaloIsoT-TrkIdT-TrkIsoT-TriCentralPFJet30-v2 \\for run number $\leq$ 179889
...
\chapter{Choice of binning for primary variables}
\label{a:binning}
...
\centering
\center{\Large\bfseries{\HT variable}}
...
\newpage
\center{\Large\bfseries{\ST variable}}
...
\newpage
\center{\Large\bfseries{\WPT variable}}
...
\newpage
\center{\Large\bfseries{\MT variable}}
...
\chapter{Systematic uncertainties of the cross section measurement}
\label{a:xsection_systematics_tables}

\input{06_Cross_section_analysis/tables/xsection_HT_systematics}
\input{06_Cross_section_analysis/tables/xsection_ST_systematics}
\input{06_Cross_section_analysis/tables/xsection_MT_systematics}
\input{06_Cross_section_analysis/tables/xsection_WPT_systematics}
