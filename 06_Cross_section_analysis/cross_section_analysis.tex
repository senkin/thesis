...
\begin{figure}[hbtp]
  \begin{center}
    ...
    \eta$ (c) and muon $\eta$ (d). Left plots: electron+jets selection, right plots: muon+jets selection.}
...
\begin{figure}[hbtp]
	\centering
	%MET
	\subfloat[]{\includegraphics[width=0.5\textwidth]{binning_choice/EPlusJets/MET}}\hfill
	\subfloat[]{\includegraphics[width=0.5\textwidth]{binning_choice/MuPlusJets/MET}}\\
	%HT
	\subfloat[]{\includegraphics[width=0.5\textwidth]{binning_choice/EPlusJets/HT}}\hfill
	\subfloat[]{\includegraphics[width=0.5\textwidth]{binning_choice/MuPlusJets/HT}}\\ 
	%ST
	\subfloat[]{\includegraphics[width=0.5\textwidth]{binning_choice/EPlusJets/ST}}\hfill
	\subfloat[]{\includegraphics[width=0.5\textwidth]{binning_choice/MuPlusJets/ST}}\\ 
...
\begin{figure}[hbtp]
	\centering
	%WPT
	\subfloat[]{\includegraphics[width=0.5\textwidth]{binning_choice/EPlusJets/WPT}}\hfill
	\subfloat[]{\includegraphics[width=0.5\textwidth]{binning_choice/MuPlusJets/WPT}}\\
	%MT
	\subfloat[]{\includegraphics[width=0.5\textwidth]{binning_choice/EPlusJets/MT}}\hfill
	\subfloat[]{\includegraphics[width=0.5\textwidth]{binning_choice/MuPlusJets/MT}}\\
