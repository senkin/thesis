...
\begin{figure}[hbtp]
   	\centering
    \subfloat[]{\includegraphics[width=0.5\textwidth]{unfolding_performance/electron_MET_RooUnfoldSvd_closure}} \hfill
    \subfloat[]{\includegraphics[width=0.5\textwidth]{unfolding_performance/electron_MET_RooUnfoldSvd_closure_finer_bins}}\\
	\subfloat[]{\includegraphics[width=0.47\textwidth]{unfolding_performance/k_from_d_i_electron_channel_MET_data}}	\hspace{0.4cm}
	\subfloat[]{\includegraphics[width=0.47\textwidth]{unfolding_performance/k_from_d_i_electron_channel_MET_bias_finer_bins}}
...
In all figures, the inner error bars (or gray bands on ratio plots) represent the combined fitting and unfolding
uncertainties, whereas the outer error bars (or yellow bands on ratio plots) include the uncertainty due to systematic
...
\begin{figure}[!htbp]
    ...
    \caption[Normalised semileptonic \ttbar differential cross section with respect to \MET]{Normalised semileptonic
      ...
      inner error bars represent the combined statistical (fitting) and unfolding uncertainties, the outer error bars
      include the systematic uncertainties added in quadrature.}
