...
\begin{figure}[hbtp]
  \begin{center}
  	%\subfloat[]{\includegraphics[width=0.50\textwidth]{control_plots/EPlusJets_N_Jets_2orMoreBtags}} \\
  	...
  	\subfloat[]{\includegraphics[width=0.50\textwidth]{control_plots/EPlusJets_patType1CorrectedPFMet_log_2orMoreBtags_with_ratio}} \\
  	...
  	\subfloat[]{\includegraphics[width=0.50\textwidth]{control_plots/electron_AbsEta_2orMoreBtags_with_ratio}}
    \caption{Data/MC comparison plots for the electron channel after the final event selection: \MET (a, b), $\phi(\MET)$
    (c), electron $|\eta|$ (d).}
    \label{fig:contol_plots_ejets}
  \end{center}
\end{figure}

\begin{figure}[hbtp]
  \begin{center}
  	%\subfloat[]{\includegraphics[width=0.50\textwidth]{control_plots/MuPlusJets_N_Jets_2orMoreBtags}} \\
  	...
  	\subfloat[]{\includegraphics[width=0.50\textwidth]{control_plots/MuPlusJets_patType1CorrectedPFMet_phi_2orMoreBtags_with_ratio}}\hfill
  	\subfloat[]{\includegraphics[width=0.50\textwidth]{control_plots/muon_AbsEta_2orMoreBtags_with_ratio}}
    \caption{Data/MC comparison plots for the muon channel after the final event selection: \MET (a, b), $\phi(\MET)$
    (c), muon $|\eta|$ (d).}
    \label{fig:contol_plots_mujets}
  \end{center}
\end{figure}
