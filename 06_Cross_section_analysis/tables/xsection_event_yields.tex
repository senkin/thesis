\begin{table}
  \centering
   ...
   and observed events from MC and data in the electron channel before the fitting process. The uncertainties
...
\begin{table}
  \centering
   \caption[Number of expected and observed events from MC and data in the muon channel]{Number of expected and
   observed events from MC and data in the muon channel before the fitting process. The uncertainties shown are
   purely statistical.}
