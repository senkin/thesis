\begin{table}
  \centering
   ...
   for the electron plus jets channel out of the box, i.e.\ before the fitting process.}
    \label{tab:eventnumberse}
...
\begin{table}
  \centering
   \caption{Numbers of expected and observed events from simulation and data
   for the muon plus jets channel out of the box, i.e.\ before the fitting process.}
    \label{tab:eventnumberse}
    \resizebox{\columnwidth}{!} {
    \begin{tabular}{lrrrrrrr}
    \toprule
