...
\begin{tabular}{@{}_c|^c|^c|^c|^c|^c|^c@{}}
 \toprule
 \rowstyle{\itshape} \multirow{2}{*}[-2pt]{Generation} & \multicolumn{3}{c|}{\textit{Leptons}} & \multicolumn{3}{c}{\textit{Quarks}} \\
 \cmidrule{2-7}
...
gauge bosons with their properties \autocite{PDG}. The gravitational force is the only fundamental interaction not
described by the Standard Model (the graviton has not been discovered yet).}
\label{tab:SM_forces} 
\begin{tabular}{@{}_l|^c|^c|^c|^c|^c@{}}
 \toprule
 \rowstyle{\itshape}Force & Gauge Boson & Charge & Spin & Mass \si{[\GeV]} & Range\\ 
 \midrule
