...
giving rise to Quantum Chromodynamics. As a matter of fact, all of the fundamental interactions in the Standard Model
are introduced using the same gauge principle. However, in order to preserve gauge invariance, the introduced gauge
fields are required to be massless, which clearly contradicts the existence of massive vector bosons. This problem is
solved by the Brout-Englert-Higgs mechanism of spontaneous gauge symmetry breaking
...
\end{equation} 
for all three generations of quarks. These components are obtained by applying the projection operators
$\frac{1}{2}(1\pm\gamma^5)$ to fermionic fields:
\begin{equation}
...
The left-handed particles are doublets with the weak isospin of $I = \frac{1}{2}$, whereas the right-handed particles are
singlets with $I = 0$.
