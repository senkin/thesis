...
\begin{itemize}
  \item fully hadronic: \ttbar $\rightarrow \cPqb \W^+ \bar{\cPqb} \W^- \rightarrow  \cPqb \cPq\bar{\cPq}' \bar{\cPqb}
  \cPq'' \bar{\cPq}'''$ (\SI{45.7}{\pc});
  \item semileptonic: \ttbar $\rightarrow \cPqb \W^+ \bar{\cPqb} \W^- \rightarrow \cPqb \cPq\bar{\cPq}' \bar{\cPqb} l^-
