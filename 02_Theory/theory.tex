...
Fully hadronic \ttbar decay signature implies at least 6 jets in the final state and no leptons, hence it is heavily
...
therefore it is usually argued that experimentally measured top quark mass represents the pole mass.
...
> \MSmtop$). However, it has recently been shown that including electroweak corrections for a Higgs boson of
...
The experimental measurement of the top quark mass is of paramount importance. Nearly 20 years of the Tevatron operation
resulted in a very good understanding of the machine and detectors, leading to an impressively small systematic
uncertainty. The latest top quark mass combination result from the Tevatron gives
\autocite{tevatron_top_mass_combination}:
\begin{equation}
...
\begin{equation}
\mtop = 173.34\ \pm\ 0.27\ \textrm{(stat.)}\ \pm 0.74\ \textrm{(syst.)}\ \textrm{GeV}.
\end{equation}

All these results compared with contributions of individual mass measurements are shown in
Figure~\ref{fig:top_mass_world_combination}. 

\begin{figure}[!hbtp]
   \centering
   {\includegraphics[width=\textwidth]{top_world_combination}}
