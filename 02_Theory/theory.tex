...
\begin{equation}
\calL = \bar{\psi}_L \gamma^\mu ( i\partial_\mu  - g \mathbf{T} \cdot \mathbf{W}_\mu - \frac{g'}{2} Y
...
\end{equation*}
and $\psi_L$ and $\psi_R$ are summed over all possibilities shown in Equations~\ref{lepton_EWK_fields} and
\ref{quark_EWK_fields}.
...
However, the existence of massive vector bosons clearly contradicts the concept of massless gauge fields in electroweak
theory. This problem is solved by the Brout-Englert-Higgs mechanism of spontaneous gauge symmetry breaking, explained in
