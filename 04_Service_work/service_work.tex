...
A set of trigger paths is combined in the HLT configuration, referred to as the HLT menu or table
\cite{HLT_commissioning}. Since the start of data-taking in 2010, the CMS trigger coordination adopted a ``trigger
...
isolation and transverse momentum criteria. However, extrapolating the trigger rates on higher luminosities foreseen in
2011, it became obvious that the rate of single electron trigger would quickly become unmanageable unless selection is
tightened to limits unacceptable for top physics. Therefore, a solution of electron-plus-jets trigger was exploited.
