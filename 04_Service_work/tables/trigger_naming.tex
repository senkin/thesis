...
points. The given values are for the barrel region of the detector and the values in brackets are for the endcap region.
The used cut variables are explained in Section~\ref{s:object_reconstruction}.}
...
VeryLoose (VL) & $H/E <$ 0.15 (0.10) &  $\text{ECAL iso}/\ET<$ 0.2 (0.2) & $\Delta\eta <$ 0.01 (0.01) & $\text{track iso}/\pt<$ 0.2 (0.2)\\
 ...
 WP80  & $H/E <$ 0.10 (0.05) &  $\text{ECAL iso}/\ET<$ 0.15 (0.1) & $\Delta\eta <$ 0.007 (0.007) & $\text{track iso}/\pt<$ 0.05 (0.05)\\
 & $\sigma_{i\eta i\eta} <$ 0.01 (0.03) & $\text{HCAL iso}/\ET<$ 0.1 (0.1) & $\Delta\phi <$ 0.06 (0.03) & \\
\bottomrule
\end{tabular}
}
\end{table}