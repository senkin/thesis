...
larger branching fraction into semi-leptonic decays with neutrinos in the final state that cannot be detected. All these
...
Underlying event \cite{underlying_event} refers to all the activity in the proton-proton collision apart from the
...
with neutrinos in the final state. Top quark pair semi-leptonic decay is one of such processes, therefore analyses
