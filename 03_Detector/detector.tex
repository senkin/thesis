...
HCAL is a sampling calorimiter consisting of alternating layers of brass and stainless steel absorbers, and plastic
...
scintillation light is guided by embedded wavelength-shifting (WLS) fibers. The light from the WLS is then transmitted
via a network of clear fibers, arranged in read-out towers, to hybrid photodiodes (HPDs) \cite{CMS}.
...
from the interaction point, and is essential to reconstruct very forward hardon jets. Together with HO, it provides the
