...
The superconducting solenoid is a very important part of the CMS detector, essentially giving it its name. The magnet
...
\begin{figure}[htbp]
  \begin{center}
    ...
    \caption{Layout of one quarter of the CMS muon system \cite{CMS_TDR1}.}
    \label{muon_system}
  \end{center}
\end{figure}

The layout of the CMS muon system is shown of Figure~\ref{muon_system}. It consists of the drift tubes (DT), cathode
strip chambers (CSC) and resistive plate chambers (RPC). The entire system is surrounding the solenoid and covers the
...
total. The chambers are filled with the gas mixture of \SI{85}{\percent} $\textrm{Ar}$ and \SI{15}{\percent}
$\textrm{CO}_2$, where the muon drift time does not exceed \SI{380}{\ns}. Although this value is bigger than the typical
bunch crossing time (\num{25} or \SI{50}{\ns}), it is sufficient because of the small muon rate.
...
endcap regions (\abs\eta\num{<2.1}). RPCs operate in avalanche mode, and due to an excellent time resolution of about
\SI{1}{\ns} they provide fast information for triggering. The spacial resolution is, however, quite limited.
