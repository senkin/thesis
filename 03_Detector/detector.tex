...
The final step in electron reconstruction is building observables for the electron identification. There are several
identification algorithms used by various CMS analyses, and four of them are used in this thesis: simple cut-based
(SCB ID), cuts in categories (CiC ID), particle flow (PF ID) and multi-variate analysis (MVA ID).
...
\begin{itemize}
  ...
  seed crystal (the one with the highest energy):
  \begin{equation}
