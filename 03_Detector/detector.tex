...
raditation (FSR), i.e.\ radiation of outgoing partons.

Theoretically, parton showers can be regarded as higher-order corrections to the hard scattering process. However,
precise calculation of these corrections is not feasible, therefore an approximation scheme is used, based on QCD
evolution equations first described by Dokshitzer, Gribov, Lipatov, Altarelli and Parisi (DGLAP) \autocite{Dokshitzer,
Gribov_Lipatov, Altarelli_Parisi}.
...
\autocite{POWHEG}. These generators are briefly described below.
...
\subsection{Matching threshold and factorisation scale}
...
\input{03_Detector/tables/systematic_mc_variations}
